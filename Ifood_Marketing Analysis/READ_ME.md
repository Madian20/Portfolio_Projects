...
IFood Customer Behavaior Analysis is an end-to-end data analytics project built on a real-world marketing dataset from Maven Analytics, covering **2,240 customers** across **25 fields** — including customer profiles, product spending, purchase channels, and responses to 5 marketing campaigns.
...
Built the database structure and created the core tables to host the raw data.
...
Surfaced patterns, distributions, and relationships across customer segments.

**6. Dashboard — Power BI**
Built an interactive dashboard that brings all findings together in a clear, decision-ready format.
